...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return <div style={{ marginBottom: 18 }}><label style={{ display: 'block', marginBottom: 7, fontSize: 11, letterSpacing: '0.14em', color: 'var(--text-muted)' }}>{label}</label>{children}</div>
}
...
const inputStyle: React.CSSProperties = { width: '100%', height: 40, boxSizing: 'border-box', border: '1px solid var(--border)', borderRadius: 6, padding: '0 12px', fontSize: 14, color: 'var(--text-primary)', background: '#F7F9FC', outline: 'none', fontFamily: 'inherit' }
