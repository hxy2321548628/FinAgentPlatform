      ...
      <aside style={{ width: 220, flexShrink: 0, background: 'var(--ws-sidebar-bg)', color: '#fff', display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ borderTop: '1px solid var(--ws-sidebar-border)' }}>
          ...
          <div style={{ padding: '12px 16px', borderTop: '1px solid var(--ws-sidebar-border)', display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%', background: 'var(--action)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 700, flexShrink: 0 }}>管</div>
            <div style={{ minWidth: 0 }}><div style={{ fontSize: 13, fontWeight: 600, color: '#fff' }}>系统管理员</div><div style={{ fontSize: 11, color: 'var(--ws-sidebar-text)', marginTop: 1 }}>admin</div></div>
          </div>
        </div>
      </aside>
