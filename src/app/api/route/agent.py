...
def _to_my_agent(detail: AgentDetail, latest: dict[str, Review], approved: set[str]) -> MyAgentResponse:
    ...
    return MyAgentResponse(
        ...
        in_catalog=detail.agent.catalog_enabled and any(one.id in approved for one in detail.versions),
        catalog_enabled=detail.agent.catalog_enabled,
        catalog_disabled_reason=detail.agent.catalog_disabled_reason,
        catalog_disabled_by=detail.agent.catalog_disabled_by,
        catalog_disabled_at=detail.agent.catalog_disabled_at,
