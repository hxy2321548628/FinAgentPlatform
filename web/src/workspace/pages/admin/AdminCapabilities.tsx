...
const reasonInputStyle: React.CSSProperties = { width: 180, padding: '6px 8px', border: '1px solid var(--border)', borderRadius: 6, fontSize: 12, fontFamily: 'inherit', outline: 'none', background: '#F7F9FC' }
