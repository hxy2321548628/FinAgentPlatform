...
const mocks = vi.hoisted(() => ({
  me: vi.fn(async () => ({ id: 'reviewer-1', name: '审核老师', role: 'reviewer' as const })),
}))
...
describe('AdminLayout', () => {
  it('reviewer 只看得到智能体与 Skill 两个审核入口', async () => {
    ...
    expect(screen.getByRole('link', { name: '智能体审核' })).toBeTruthy()
