...
3. **（2026-08-19 加）A9 落地之后 E03 那一类题还剩多少钱**：首轮它单题 1.30 元、占九题总额的一半。如果卸载之后它掉到与其它题同量级，那么 A1 的压缩阈值（40000，首轮触发 0 次）多半可以一直放着不动 —— **压缩要解决的那个场景，被更便宜的第一层拦掉了**。反之则说明 40000 定高了。
